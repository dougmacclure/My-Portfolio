...
char quit[] = "quit";
int pipefd[2], rs, pid, status, rs1, chd1, chd2;
...
// first child process	
	...
	if(chd1 == 0) {  
		...
		else if(strcmp(argv1[5], empty) == 0)
		
			rs1 = execlp(argv1[0], argv1[0], argv1[1], argv1[2], argv1[3], argv1[4], NULL);
		...
		*/
		...
		else if(strcmp(argv2[5], empty) == 0)
		
			rs1 = execlp(argv2[0], argv2[0], argv2[1], argv2[2], argv2[3], argv2[4], NULL);
